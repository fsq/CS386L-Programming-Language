...
Proof.
  ...
  - generalize dependent t'. induction t;intros.
    + unfold subst in H. destruct (beq_string x0 s0) eqn:Q;subst.
      * apply beq_string_true_iff in Q. rewrite Q. apply s_var1.
      * apply beq_string_false_iff in Q. constructor. assumption.
    + simpl in H. rewrite<-H. constructor.
      * apply IHt1. reflexivity. 
      * apply IHt2. reflexivity.
    + simpl in H. destruct (beq_string x0 s0) eqn:Q; subst.
      * apply beq_string_true_iff in Q. rewrite Q. constructor.
      * apply beq_string_false_iff in Q. constructor. assumption.
  ...
  - generalize dependent t'. induction t;intros.
    + unfold subst. inversion H;subst.
      ...
      * rewrite<-beq_string_false_iff in H1. rewrite H1. reflexivity.
    + simpl. inversion H;subst. apply IHt1 in H2. apply IHt2 in H4.
      rewrite H2. rewrite H4. reflexivity.
    + simpl. inversion H;subst.
      * rewrite<-beq_string_refl. reflexivity.
      * rewrite<-beq_string_false_iff in H4. rewrite H4. apply IHt in H5.
...
Example typing_example_3 :
  exists T,
    empty |-
      ...
      T.
Proof with auto.
  eapply ex_intro. apply T_Abs. apply T_Abs. apply T_Abs.
  eapply T_App. 
